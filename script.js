...
function makeBgArr() {
  let i = 0
  while (i < 6) {
    let randomBg = `https://raw.githubusercontent.com/DidenkoSveta/momentum/images/night/${Math.floor(Math.random() * 20 + 1)}.jpg`
  ...
  while (i < 12) {
    let randomBg = `https://raw.githubusercontent.com/DidenkoSveta/momentum/images/morning/${Math.floor(Math.random() * 20 + 1)}.jpg`
    if (!bgrArr.includes(randomBg)) {
      bgrArr.push(randomBg)
      i++
    }
  ...
  while (i < 18) {
    let randomBg = `https://raw.githubusercontent.com/DidenkoSveta/momentum/images/afternoon/${Math.floor(Math.random() * 20 + 1)}.jpg`
    if (!bgrArr.includes(randomBg)) {
      bgrArr.push(randomBg)
      i++
    }
  ...
  while (i < 24) {
    let randomBg = `https://raw.githubusercontent.com/DidenkoSveta/momentum/images/evening/${Math.floor(Math.random() * 20 + 1)}.jpg`
    if (!bgrArr.includes(randomBg)) {
      bgrArr.push(randomBg)
      i++
    }
